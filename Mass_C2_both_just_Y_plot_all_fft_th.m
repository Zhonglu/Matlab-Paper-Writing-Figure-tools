...
%         plot(t2,y2,'r--');
    ...
    xlabel('$tf_n$','Interpreter','LaTex','FontSize',22)
    ylabel('$Y_2/D$','Interpreter','LaTex','FontSize',22)
    
    hl=legend('$Y_{2,val}/D$','$Y_2/D$');set(hl,'Interpreter','latex','FontSize',22);
...
%     Cy2_sin = w'.*Cy2_sin'; 
    ...
    yyaxis left
    ylabel('$C$','Interpreter','LaTex','FontSize',22)
    yyaxis right
    ylabel('$Y/D$','Interpreter','LaTex','FontSize',22)
    plot(t2,y2,'k:');
    ...
    hl=legend('$C_{Y2}$','$C_{Y2,sin}$','$Y_2/D$','$Y_{2,sin}/D$');set(hl,'Interpreter','latex','FontSize',22);
    ...
    plot(f,P1,'color','r','LineStyle','--');
    xlim([0 2.4]);%ylim([-0.3 0.3]);
    xlabel('$f/f_n$','Interpreter','LaTex','FontSize',22)
    temp=['$f_1/f_n=',num2str(f1),'$'];
    hl = legend(['$C_{Y2}$ ',temp],['$Y_2/D$\ \ \ ',temp]);set(hl,'Interpreter','latex','FontSize',22);
    ...
    plot(f,P1,'color','k','LineStyle','-');
    ylabel('$C_{AY2,sin}$','Interpreter','LaTex','FontSize',22)
    yyaxis right
    ylabel('$Y_{A2,sin}/D$','Interpreter','LaTex','FontSize',22)
    [f, P1]=fftzp2(t2_sin,y2_sin);
    plot(f,P1,'color','r','LineStyle','--');
    xlim([0 2.4]);%ylim([-0.3 0.3]);
    xlabel('$f/f_n$','Interpreter','LaTex','FontSize',22)
    temp=['$f_1/f_n=',num2str(f1),'$'];
    hl = legend(['$C_{Y2,sin}$ ',temp],['$Y_{2,sin}/D$\ \ \ ',temp]);set(hl,'Interpreter','latex','FontSize',22);
...
if condit
    ...
    hl=legend('$C_{Y2}$','$C_{Y2,val}$');set(hl,'Interpreter','latex','FontSize',22);
    xlim([237 240]);ylim([-1 1]);
    xlabel('$tf_n$','Interpreter','LaTex','FontSize',22)
    ...
    hl=legend('$(4\pi^2Y_2)/D$','$(d^2Y_2/dt^2)/D$','$(4\pi^2Y_2+d^2Y_2/dt^2)/D$','$C_{Y2,val}$');set(hl,'Interpreter','latex','FontSize',22);
    xlim([237 240]);ylim([-1 1]);
...
%xlabel('$f_2/f_n$','Interpreter','LaTex','FontSize',22)
%ylabel('$C_{AY2}$','Interpreter','LaTex','FontSize',22);
...
if ~exist('f1','var') || isempty(f1)
    ...
    temp=['$f_1/f_n=',num2str(f1),'$'];
    hl = legend(['$Y_2/D$\ \ \ ',temp]);%['$C_{Y2}$ ',temp],
...
ylabel('$A/D$','Interpreter','LaTex','FontSize',22);
