...
elseif fnum==1
    ...
    if file==-1
        CL=0;t=0;disp('file open fail');stop
    else
        ...
        t=f002m(:,1);% time
        Fy02=f002m(:,3);% C2, Fy/(D/2), Fy is total force in y direction
        CL=Fy02/( (2*pi*A1*f1)^2 );
        ...
        elseif fnum==27
            Fy02_7=f002m(:,7); %  pressure force in y direction
