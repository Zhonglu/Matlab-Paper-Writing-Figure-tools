...
errlim=0.75;%error limit for autocut
sysdir2
...
for j=1:n0 %1:n0
    ...
    taskid=gamr(6);
    %%
    if taskid<9326; continue; end
    if taskid>9340; continue; end
...
if condit
    ...
    t1_pre=t1;y1_pre=y2;
    if autocut_switch; [t1,y1,t2,y2]=autocut(f1,t1,y1,t2,y2);end
...
if or(ylimr(2)==0,ratio==0)
    disp('alignment failed due to ratio==0')
else
