...
copyall_or_not=1;
%ftspara=0.0000625/2;%normally 0.00025 for interaction of two cylinders
...
%ristart=9316;% Free_cylinder_validation_manuscript
%ristart=9401;% G1.5
%ristart=9501; % G1.0
ristart=9601; % G1.1
...
for sn=11:11 %1~8 for Free_cylinder_validation_manuscript
    %sn=9 for G1.5
    %sn=10 for G1.0
    %sn=11 for G1.1
    ...
    if sn==9 %A1 varies
        gii=[1.5];
        reii=[15 20 25 27 30 40 50 60 80 100];
        aii=1;
        mii=[1];
        dampii=[0];% not used for free cylinder cases
    end
...
for ii=1:nn
    ...
    NITRB= '300';       % MAXIMUM ITERATION STEP FOR MESH UPDATE EUQATION
