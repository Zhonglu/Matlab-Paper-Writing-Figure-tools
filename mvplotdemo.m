...
load Eureqa_extract_6.dat
ggroup=ones(length(Eureqa_extract_6),1);

%figure
%gplotmatrix(Eureqa_extract_6,Eureqa_extract_6,ggroup);


varNames = {'$G/D$'; '$A_1/D$'; '$m^*$'; '$\zeta$'; '$f_1/f_n$';'$Re_m$';'$A_2/D$'};
figure
gplotmatrix(Eureqa_extract_6(:,1:6),Eureqa_extract_6(:,7),ggroup,[],[],[],'off','',varNames(1:6),varNames(7));


X = [G/D,	A1/D	,mr, d	,f1	,Re,	A2/D];
