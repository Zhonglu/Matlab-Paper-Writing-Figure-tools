...
fid = fopen(['./2_subauto_hpc_',num2str(ristart),'_to_',num2str(ri)], 'w');                
for ii = 1:length(txt)
        fprintf(fid,'%s\n', txt{ii});
end

start_task_num=ristart;
end_task_num=ri-1;%117+18-1;
...
for ii=1:nn
    ...
    ftspara=0.00025;%normally 0.004
