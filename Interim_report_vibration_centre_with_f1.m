...
for j=4:4
    ...
    for i=[0.8/0.05, 2./0.05, 2.5/0.05]
        dirnamef=[list0(j).name,'/',list(i).name,'/'];
        %v01=load([dirname,'VIV01.DAT']);
        ...
        plot(v02(1:num,1),v02(1:num,4)) % y displacement of cylinder 2 (free)
        hold on
    ...
    legend('G=3.0  A_1=2.0  f_1=0.8','G=3.0  A_1=2.0  f_1=2.0','G=3.0  A_1=2.0  f_1=2.5','Location','northeast')
    xlabel('t * f_n_2');
    ylabel('Y_2 / D');
