...
foldername='g0.05a0.035m2.5zl_r26';
...
%% 
    ...
    txtp{24} = ['#PBS -l walltime=',walltime];
    txtp{7} = taskdir;     %running dir 
    txtp{8} = ['/projects/y73/dongfang/code',codename,'/viv > test.e']; %code dir
%%  write txt
    cd ('../')
    cd (list0(j).name)
