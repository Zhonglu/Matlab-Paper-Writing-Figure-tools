...
for j=1:n0 %1:n0
    ...
    for i=1:n % i=1:n
        ...
        figure(17);hold on;plot(f1s,cphsc2f1-yphsc2f1);title('C2 force-disp phase diff at f=f1') % plot phase difference
        ...
        figure(18);hold on;plot(f1s,cphsc2f1-yphsc1f1); title('C2 force - C1 disp phase diff at f=f1') % plot phase difference
        ...
        %figure(19);hold on;plot(f1s,cphsc2f1-cphsc1f1); title('C2 force - C1 force phase diff at f=f1') % plot phase difference
        %grid on; yticks([0:45:180]); xticks([0:0.25:2.5]);xlabel('$f_1/f_n$','Interpreter','LaTex','FontSize',20);ylabel('Phase (degrees)','Interpreter','LaTex','FontSize',20)
        ...
        plot(f1s,temp1); title('C2-C1 disp phase diff at f=f1') % plot phase difference
        grid on; yticks([0:45:180]); xticks([0:0.25:2.5]);xlabel('$f_1/f_n$','Interpreter','LaTex','FontSize',20);ylabel('Phase (degrees)','Interpreter','LaTex','FontSize',20)
