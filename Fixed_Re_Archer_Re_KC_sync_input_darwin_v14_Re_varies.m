...
%     0.9
%     ];
%tstr=walltime; tstr(tstr==':')=' '; arwt=str2num(tstr); if arwt(2)>12; long_or_not
...
for ii=1:nn
    ...
    if ii<=5
        account='e556-zl352';% e556-zl352 (Archer dring test)
    elseif ii<=10
        account='e556-jm2104';
    elseif ii<=15
        account='e556-sr734';
    ...
    for ifa=1:nfarm
        ...
        txtp{19} = ['/work/e556/e556/',account(6:end),'/scratch/code7/viv > ${taskindex}.out 2> ${taskindex}.err'];
        % write
