...
for ii=1:nn
    ...
    old_dist=true;%true=not refined, false=refined
    if old_dist==true
        disp('old distribution of frequency series')
    else
        disp('refined distribution of frequency series')
    end
