...
writeing_directory='/Users/zhonglulin/Documents/OneDrive - University Of Cambridge/OneDrive/PhDWorks/VIV/Chosen_mesh_19_Dec';
%mesh_viv_version1.msh
%original_msh='mesh_viv_version4_large_gap.msh';
original_msh='mesh_viv_version4_large_gap.msh';
fid = fopen(original_msh,'r');
i = 0;
disp(['original msh file is ', original_msh])
disp(['writeing_directory is ',writeing_directory])
