...
[t1,y1]=textscan_ft(A1,f1,1);% 1 denotes force coefficient
dt1=t1(20)-t1(19);           
[t2,y2]=textscanty(1);         % 2 denotes displacement
dt2=t2(20)-t2(19);  
...
ylabel('$C_{Y1}$','Interpreter','LaTex','FontSize',20)
...
%%
cutf=0;
for i=1:length(f); if f(i)>5; cutf=i; break; end;end
f=f(1:cutf);P1=P1(1:cutf);
...
ylabel('$C_{YA1}$','Interpreter','LaTex','FontSize',20);
...
ylabel('$A_1$','Interpreter','LaTex','FontSize',20);
